...
## Current phase: **v1.0.x — Jan's review round** (v1.0.0 tagged 2026-08-30; Phase 10.6 shipped the same day: academy press lesson corrected per system, card escalation with FIH shapes, every goal reviewable as a clip with the system answer, kickoff shape after goals, the halfway five defend the corner — `docs/handoff/phase-10.6.md`. Next big phase — **competitions of Europe — SHIPPED 2026-08-31** as Phase 12: five national leagues (NL/EN/FR/DE alongside the home country, formats as data), the European club knockout in the winter break (coachable when your club qualifies), and a nine-nation Pro League-format nations competition; save v5, `docs/handoff/phase-12.md`.)
