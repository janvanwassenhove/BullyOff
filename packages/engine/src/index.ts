...
export { matchStats, aggregate, quarterStats, type MatchStats, type Aggregate, type QuarterStats } from './sim/stats.js';
...
export { aiController, createAi, squadsFromSetup, passSpeedFor, type AiTeam, type SquadPlayer, type AiOptions, type AiHandle, type CoachInstruction } from './ai/brain.js';
